...
public class TestClass {
	...
	public static void main(String[] args) {
		//Hämtar start-stations numret och end-stations numret, samt resultatnumret.
	   ...
	   //Gör en arraylist för alla stationer.
		ArrayList<Station> searchStations = new ArrayList<Station>();
		
		//Hämtar alla stationer från URL.
